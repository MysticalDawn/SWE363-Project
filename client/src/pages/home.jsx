...
export const Home = () => {
  ...
  const [fullText] = useState("Co-op and Summer Training Opportunities for KFUPM students🧑‍🎓");
      ...
      <div className="home-wrapper">
        <div className="left-section">
          ...
          <p className="info">
            ...
            training opportunity in different companies. It takes the hassle out of the process of finding a co-op or summer training opportunity. 
          </p>
          <Link to="/catalog">
